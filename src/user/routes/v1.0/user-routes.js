...
/**
 * @openapi
 * /api/v1.0/user/{userId}/history/tasks/{taskId}:
 *  get:
 *     tags:
 *     - User Handlers
 *     summary: Get a specific task that has been assigned to the user
 *     parameters:
 *      - name: userId
 *        in: path
 *        description: The id of the user
 ...
 */
router.get(
    '/:userId/history/tasks/:taskId',
    verifyToken,
    hasPermissions([ROLES.ADMIN, ROLES.PROJECT_MANAGER, ROLES.TEAM_MEMBER, ROLES.TECHNICAL_LEADER]),
    userHandler.getOneUserHistoryTaskHandler
);

/**
 * @openapi
 * /api/v1.0/user/{userId}/currently-assigned-tasks:
 *  get:
 *     tags:
 *     - User Handlers
 *     summary: Get all tasks currently assigned to the user
 *     parameters:
 *      - name: userId
 *        in: path
 *        description: The id of the user
 ...
 */
router.get(
    '/:userId/currently-assigned-tasks',
    verifyToken,
    hasPermissions([ROLES.ADMIN, ROLES.PROJECT_MANAGER, ROLES.TEAM_MEMBER, ROLES.TECHNICAL_LEADER]),
    userHandler.getAllUserCurrentlyAssignedTasksHandler
);

/**
 * @openapi
 * /api/v1.0/user/{userId}/currently-assigned-tasks/{taskId}:
 *  get:
 *     tags:
 *     - User Handlers
 *     summary: Get a specific current task that has been assigned to the user
 *     parameters:
 *      - name: userId
 *        in: path
 *        description: The id of the user
 ...
 */
router.get(
    '/:userId/currently-assigned-tasks/:taskId',
    verifyToken,
    hasPermissions([ROLES.ADMIN, ROLES.PROJECT_MANAGER, ROLES.TEAM_MEMBER, ROLES.TECHNICAL_LEADER]),
    userHandler.getOneUserCurrentlyAssignedTaskHandler
);
